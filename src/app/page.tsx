        ...
        {!hasEntered && (
          ...
          >
            ...
            <motion.p
              ...
              className="text-sm tracking-[0.3em] uppercase text-gray-400 font-mono mb-8"
            >
              SAJITH BANDARA
            </motion.p>
            ...
            <motion.button
              ...
              className="group relative px-8 py-3 rounded-full font-bold tracking-[0.15em] uppercase text-[#050505] bg-[#F37512] shadow-[0_0_40px_rgba(243,117,18,0.3)] hover:shadow-[0_0_60px_rgba(243,117,18,0.5)] transition-shadow duration-500"
            >
              {/* Glow ring on hover */}
            ...
            <motion.p
              ...
              className="absolute bottom-10 text-xs tracking-widest uppercase text-gray-600 font-mono"
            >
